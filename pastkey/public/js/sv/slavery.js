...
app.slavery = (function () {
    ...
    var viz = null;
    var csls = {  //Chattel Slavery Legal Status
        slavery:{color:"#f1625c", ti:"Slavery", desc:"Legalized slavery, or official record of chattel slaves being held. Whichever date is earliest used for when slavery started."},
        illegal:{color:"#faae66", ti:"Illegal", desc:"Slaves recorded, but slavery illegal, or new slavery illegal, or legal recourse for slaves to be freed."},
        free:{color:"#fadb66", ti:"Free", desc:"No officially recorded slaves"}};
    ...
    var sps = [{state:"AK", name:"Alaska",
               ...
               {state:"AL", name:"Alabama",
                periods:[{yr:1721, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"AR", name:"Arkansas",
                periods:[{yr:1720, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"AZ", name:"Arizona",
                periods:[{yr:1692, status:"slavery"},
                         {yr:1862, status:"free"}],
               ...
               {state:"CA", name:"California",
                periods:[{yr:1848, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"CT", name:"Connecticut",
                periods:[{yr:1639, status:"slavery"},
                         {yr:1784, status:"illegal"},
                         {yr:1848, status:"free"}],
               ...
               {state:"FL", name:"Florida",
                periods:[{yr:1581, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"GA", name:"Georgia",
                periods:[{yr:1751, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"KY", name:"Kentucky",
                periods:[{yr:1750, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"LA", name:"Louisiana",
                periods:[{yr:1710, status:"slavery"},
                         {yr:1864, status:"free"}],
               ...
               {state:"MA", name:"Massachusetts",
                periods:[{yr:1638, status:"slavery"},
                         {yr:1781, status:"illegal"},
                         {yr:1790, status:"free"},
                         {yr:1830, status:"illegal"},
                         {yr:1840, status:"free"}],
               ...
               {state:"MD", name:"Maryland",
                periods:[{yr:1642, status:"slavery"},
                         {yr:1864, status:"free"}],
               ...
               {state:"ME", name:"Maine",
                periods:[{yr:1736, status:"slavery"},
                         {yr:1781, status:"illegal"},
                         {yr:1820, status:"free"}],
               ...
               {state:"MI", name:"Michigan",
                periods:[{yr:1761, status:"slavery"},
                         {yr:1787, status:"illegal"},
                         {yr:1837, status:"free"}],
               ...
               {state:"MN", name:"Minnesota",
                periods:[{yr:1820, status:"illegal"},  //Missouri Compromise
                         {yr:1858, status:"free"}],
               ...
               {state:"MS", name:"Mississippi",
                periods:[{yr:1699, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"NC", name:"North Carolina",
                periods:[{yr:1655, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"ND", name:"North Dakota",
                periods:[{yr:1802, status:"slavery"},
                         {yr:1820, status:"free"}],
                notes:"The first recorded non-Indian child born in North Dakota was in 1802 to Black slaves Pierre Bonza and his wife. Non-Native population and infrastructure was sparse until railroads beginning in 1872. The Missouri Compromise prohibited slavery in 1820. North Dakokta becomes a state in 1889."},
               {state:"NE", name:"Nebraska",
                periods:[{yr:1855, status:"slavery"},
                         {yr:1861, status:"free"}],
               ...
               {state:"NH", name:"New Hampshire",
                periods:[{yr:1645, status:"slavery"},
                         {yr:1857, status:"illegal"},
                         {yr:1865, status:"free"}],
                notes:"Slaves are noted in New Hampshire in 1645, primarily around Portsmouth. New Hampshire did not impose a tariff on import of slaves and was a popular port. The 1783 state constitution states 'all men are born equal and independent' but this does not lead to any judicial action freeing slaves. A law banning discrimination for citizenship is passed in 1857, but slavery explicitely ends with ratification of the 13th amendment."},
               {state:"NJ", name:"New Jersey",
                periods:[{yr:1626, status:"slavery"},
                         {yr:1804, status:"illegal"},
                         {yr:1865, status:"free"}],
                notes:"New Jersey was originally part of New Netherlands which had slaves beginning in 1626. In 1664 they offer land grants per slave to encourage slavery. A gradual abolition act is passed in 1804. Slavery was permanently abolished in 1846, but at the start of the civil war there were 18 \"apprentices for life\". The last 16 slaves are freed on ratification of the 13th amendment."},
               ...
               {state:"OH", name:"Ohio",
                periods:[{yr:1787, status:"illegal"},
                         {yr:1865, status:"free"}],
               ...
               {state:"OK", name:"Oklahoma",
                periods:[{yr:1832, status:"slavery"},
                         {yr:1863, status:"free"}],
               ...
               {state:"OR", name:"Oregon",
                periods:[{yr:1853, status:"slavery"},
                         {yr:1857, status:"illegal"},
                         {yr:1865, status:"free"}],
               ...
               {state:"TN", name:"Tennessee",
                periods:[{yr:1766, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"TX", name:"Texas",
                periods:[{yr:1821, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"UT", name:"Utah",
                periods:[{yr:1847, status:"slavery"},
                         {yr:1862, status:"free"}],
               ...
               {state:"VA", name:"Virginia",
                periods:[{yr:1619, status:"slavery"},
                         {yr:1865, status:"free"}],
               ...
               {state:"WI", name:"Wisconsin",
                periods:[{yr:1725, status:"slavery"},
                         {yr:1820, status:"illegal"},  //Missouri Compromise
                         {yr:1848, status:"free"}],
               ...
               {state:"WV", name:"West Virginia",
                periods:[{yr:1748, status:"slavery"},
                         {yr:1865, status:"free"}],
    ...
    var tlpts = [
            ...
            {date:"1804",
             text:"New Jersey passes an emancipation law.",
             //Original point stated that "All states north of the
             //Mason-Dixon Line now have laws forbidding slavery or
             //providing for its gradual elimination." but that's not true of
             //NH, and misleading w/r/t the territories.
    ...
    function getColorForState (st, year) {
        var period = {yr:0, status:"free"};
        if(st.periods) {
            //Find the most recent period <= to the current year
            var i = 0;
            while(i < st.periods.length) {
                if(st.periods[i].yr <= year) {
                    period = st.periods[i]; }
                else {  //only future periods left to consider
                    break; }
                i += 1; } }
        return csls[period.status].color;
    }
    ...
    function verifyVisualizationInitialized () {
        ...
        sps.forEach(function (sp) {
            if(sp.periods) {
                sp.periods.forEach(function (period) {
                    var year = String(period.yr);
                    if(!viz.yrtrs.csvcontains(year)) {
                        viz.yrtrs = viz.yrtrs.csvappend(year);
                        allpts.push({date:year, text:""}); } }); } });
    ...
    function writeColorCodesToTextPlaceholderDisplay() {
        var html = [];
        Object.values(csls).forEach(function (status) {
            html.push(["div", {cla:"colorcodediv",
                               style:"background:" + status.color + ";"},
                       status.ti]); });
        jt.out("kytbgdiv", jt.tac2html(
            ["div", {id:"slvccdiv"}, html]));
    }
