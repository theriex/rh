...
app.miscegenation = (function () {
    ...
    var viz = null;
    var amls = {  //Anti-Miscegenation Legal Status
        law:{color:"#ffb783", ti:"Law in effect", desc:"Anti-Miscegenation law in force"},
        exp:{color:"#ffa15c", ti:"Law updated", desc:"Anti-Miscegenation law in force and updated"},
        free:{color:"#fadb66", ti:"Free", desc:"No anti-miscegenation law in effect"}};
    var allpts = null;
    //nodisp:true means don't bother displaying the text.  Used when the
    //point is only a legal status change without any other real info.  Gets
    //tedious to read otherwise.
    var sps = [{state:"AK", name:"Alaska", points:[]},  //none
               ...
               {state:"AZ", name:"Arizona", points:[
                   { date:"1865", source:"ksep: R48", text:"Arizona prohibits “All marriages of white persons with negroes, mulattoes, Indians, or Mongolians.” This is the first use of the term “Mongolian” as a racialized term for Asian Americans in anti-miscegenation laws.", color:amls.exp.color },
                   { date:"1931", text:"Arizona adds \"Filipinos\" and \"Hindus\" to their list of races.", nodisp:true},
                   { date:"1962", source:"ksep: R113", text:"Arizona legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"CA", name:"California", points:[
                   ...
                   { date:"1880", text:"California expands its anti-miscegenation law to explicitely prohibit marriage between Whites and “Mongolians”", nodisp:true, color:amls.exp.color },
                   { date:"1933", source:"ksep: A47", text:"California’s anti-miscegenation law is amended again to explicitely exclude \"members of the Malay race\" in order to illegalize Filipino-White marriages.", nodisp:true, color:amls.exp.color },
                   { date:"1948", source:"ksep: R78", text:"California legalizes interracial marriage. In Perez v. Sharp the California State Supreme court held that state anti-miscegenation law violated due process and equal protection of the laws.", nodisp:true, color:amls.free.color }]},
               {state:"CO", name:"Colorado", points:[
                   ...
                   { date:"1957", text:"Colorado legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"GA", name:"Georgia", points:[
                   ...
                   { date:"1927", source:"ksep: R76", text:"Georgia passes all-encompassing anti-miscegenation law: “It shall be unlawful for a white person to marry anyone but a white person. Any marriage in violation of this section shall be void.”", color:amls.exp.color }]},
               {state:"IA", name:"Iowa", points:[
                   ...
                   { date:"1851", source:"ksep: R37", text:"Iowa legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"ID", name:"Idaho", points:[
                   { date:"1864", text:"Idaho prohibits intermarriage between Whites and Negroes, mulattos or Chinese.", color:amls.exp.color, nodisp:true },
                   { date:"1921", text:"Idaho expands its anti-miscegenation law to explicitely prohibit marriage between Whites and all “Mongolians”.", nodisp:true, color:amls.exp.color },
                   { date:"1959", text:"Idaho legalizes interracial marriage.", nodisp:true, col:amls.free.color }]},
               {state:"IL", name:"Illinois", points:[
                   ...
                   { date:"1874", source:"ksep: R55", text:"Illinois legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"IN", name:"Indiana", points:[
                   ...
                   { date:"1965", text:"Indiana legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"KS", name:"Kansas", points:[
                   ...
                   { date:"1859", source:"ksep: R36", text:"Kansas legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"MA", name:"Massachusetts", points:[
                   ...
                   { date:"1840", source:"ksep: R32", text:"Massachusetts repeals its anti-miscegenation law.", nodisp:true, color:amls.free.color },
                   { date:"1843", source:"ksep: R33", text:"Massachusetts legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"ME", name:"Maine", points:[
                   { date:"1821", source:"ksep: R22", text:"Maine prohibits intermarriage between Whites and Negroes, Indians, or mulattos.", color:amls.law.color, nodisp:true },
                   { date:"1883", text:"Maine legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"MI", name:"Michigan", points:[
                   ...
                   { date:"1883", text:"Michigan legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"MS", name:"Mississippi", points:[
                   ...
                   { date:"1892", text:"Mississippi expands its anti-miscegenation law to explicitely prohibit marriage between Whites and “Mongolians”.", nodisp:true, color:amls.exp.color }]},
               {state:"MT", name:"Montana", points:[
                   { date:"1909", text:"Montana prohibits intermarriage between Whites and Negroes, mulattos, or Chinese and Japanese.", nodisp:true, color:amls.exp.color },
                   { date:"1953", source:"ksep: R82", text:"Montana legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"ND", name:"North Dakota", points:[
                   ...
                   { date:"1955", source:"ksep: R84", text:"North Dakota legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"NE", name:"Nebraska", points:[
                   ...
                   { date:"1913", text:"Nebraska expands its anti-miscegenation law to explicitely prohibit marriage between Whites and Chinese or Japanese.", nodisp:true, color:amls.exp.color },
                   { date:"1963", text:"Nebraska legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"NM", name:"New Mexico", points:[
                   ...
                   { date:"1866", source:"ksep: R49", text:"New Mexico legalizes interracial marriage.", color:amls.free.color, nodisp:true }]},
               {state:"NV", name:"Nevada", points:[
                   { date:"1861", source:"ksep: R43", text:"In response to Chinese immigration, Nevada passes the first anti-miscegenation laws explicitly targeting Asian Americans, prohibiting marriage between Blacks, mulattos, Indians, and Chinese.", color:amls.exp.color },
                   { date:"1912", source:"ksep: R67", text:"Nevada updates its anti-miscegenation law to address Filipino immigration and add “color” language: “It shall be unlawful for any person of the Caucasian or white race to intermarry with any person of the Ethiopian or black race, Malay or brown race, Mongolian or yellow race, or the American Indian or red race, within the State of Nevada”", color:amls.exp.color },
                   { date:"1959", text:"Nevada legalize interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"OH", name:"Ohio", points:[
                   ...
                   { date:"1887", source:"ksep: R58", text:"Ohio legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"OR", name:"Oregon", points:[
                   ...
                   { date:"1866", text:"Oregon expands its anti-miscegenation law to explicitely prohibit marriage between Whites and Chinese.", nodisp:true, color:amls.exp.color },
                   { date:"1893", text:"Oregon expands its anti-miscegenation law to explicitely prohibit marriage between Whites and all “Mongolians”.", nodisp:true, color:amls.exp.color },
                   { date:"1951", source:"ksep: R81", text:"Oregon legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"PA", name:"Pennsylvania", points:[
                   ...
                   { date:"1780", source:"ksep: R14", text:"Pennsylvania legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               {state:"RI", name:"Rhode Island", points:[
                   ...
                   { date:"1868", source:"ksep: R51", text:"Rhode Island legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"SD", name:"South Dakota", points:[
                   ...
                   { date:"1913", text:"South Dakota prohibits marriage of \"persons belonging to the African, Corean [sic], Malayan, or Mongolian race with any person of the opposite sex belonging to the Caucasian or White race\".", nodisp:true, color:amls.exp.color },
               ...
               {state:"UT", name:"Utah", points:[
                   ...
                   { date:"1888", text:"Utah expands its anti-miscegenation law to explicitely prohibit marriage between Whites and “Mongolians”.", nodisp:true, color:amls.exp.color },
                   { date:"1963", text:"Utah legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"WA", name:"Washington", points:[
                   ...
                   { date:"1868", source:"ksep: R50", text:"Washington Territory legalizes interracial marriage.", nodisp:true, color:amls.free.color }]},
               ...
               {state:"WY", name:"Wyoming", points:[
                   { date:"1869", text:"Wyoming prohibits \"all marriages of white persons with Negroes, Mulattoes, Mongolians or Malays\".  The law is repealed before reaching statehood, then reinstated in 1913", nodisp:true, color:amls.exp.color },
                   { date:"1965", text:"Wyoming legalizes interracial marriage.", nodisp:true, color:amls.free.color }]}];
    var tlpts = [
    ...
    function getHTMLForState (st) {
        ...
        if(!st.points || !st.points.length) {
            ...
            if(st.points[st.points.length - 1].color !== amls.free.color) {
    ...
    function prepPointData (pt, idx, idprefix) {
        ...
        if(!pt.communities) {
            ...
            if(pt.color === amls.exp.color || pt.color === amls.free.color) {
    ...
    function writeColorCodesToTextPlaceholderDisplay() {
        var html = [];
        Object.values(amls).forEach(function (status) {
            html.push(["div", {cla:"colorcodediv",
