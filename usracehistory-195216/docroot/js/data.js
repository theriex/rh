...
app.data = { 
  ...
  ptcs:[
    { name:"Native American", type:"usrace",
      ident:"Native",
      code:"N",
      over:undefined,
    ...
    { name:"African American", type:"usrace",
      ident:"Black",
      code:"B",
      over:undefined,
    ...
    { name:"Asian American", type:"usrace",
      ident:"AsAm",
      code:"A",
      over:undefined,
    ...
    { name:"Unusual", type:"marker",
      ident:"Intro",
      code:"U",
      over:"Good points to use for the initial intro before chronological." },
    { name:"Firsts and Famous",  type:"marker",
      ident:"Fame",
      code:"F",
      over:"Recognition of pioneers and leaders breaking barriers." },
    { name:"Anchor Date", type:"marker",
      ident:"Date",
      code:"D",
  ...
  pts:[
    ...
    { code:"NL", cid:"N1",
      date:"1200 BCE", pic:"OlmecHead3.png",
    ...
    { code:"NL", cid:"N2",
      date:"1000 BCE", pic:"GoldChavin.png",
    ...
    { code:"NLD", cid:"N3",
      date:"1000 BCE", pic:"ChichenItza.png",
      text:"Mayan civilization flourishes in the Yucatan peninsula and Guatemala. At its peak, Teotihuacán is one of the largest cities in the entire ancient world with over one hundred thousand people. The civilization dominates the culture of the valley of Mexico for almost a millenium and stands as the most significant cultural influence throughout the history of Central American civilizations." },
    { code:"NL", cid:"N4",
      date:"600",
    ...
    { code:"NL", cid:"N5",
      date:"700", pic:"Teotihuacan.png",
      text:"Teotihuacán is conquered by northern tribes/Nations and begins to rapidly decline in its influence over the Mexican peoples. For two hundred years following the decline of Teotihuacán, the region has no centralized culture or political control." },
    { code:"ND", cid:"N6",
      date:"950", pic:"ToltecWarriorColumns.png",
    ...
    { code:"NLD", cid:"N9",
      date:"1320-1350",
      text:"The Aztec capital of Tenochtitlan-Tlatelolco begins to rise. The term \"Aztec\" is imprecise. Properly speaking, all the Nahua-speaking peoples in the Valley of Mexico were Aztecs, while the culture that dominated the area was a tribe of the Mexica (pronounced \"me-shee-ka\") called the Tenochca (\"te-noch-ka\"). At the time of the European conquest, they called themselves either \"Tenochca\" or \"Toltec\". The Mexica migrated from the north into the Valley of Mexico after the Classic Period in Mesoamerica but as early as the twelfth century AD." },
    { code:"NLD", cid:"N10",
      date:"1426-1428",
    ...
    { code:"NLD", cid:"N11",
      date:"1440's", pic:"MachuPicchu.png",
    ...
    { code:"RU", cid:"R1",
      date:"1614", pic:"JohnRolfeAndPocahontas.png",
    ...
    { code:"NU", cid:"N39",
      date:"1755-11-03",
      text:"The Lieutenant-Governor of Massachusetts, seeking to elminate all Penobscot Indians, offers £40 for each male scalp and £20 for each female or child scalp. Rewards for capture are only marginally higher. £40 is over $6,000 today." },
    { code:"ND", cid:"N35",
    ...
    { code:"N", cid:"N63", sv:"pc",
      date:"1848-1855",
      text:"The California Gold Rush further reduces the Native American population from 150,000 (half the population before white contact) to 30,000.  Native Americans are exploited as mine labor and murdered for racial and economic motives.  Many die from disease or starve to death with the destruction of their food supply by hunting and mining.  Others are driven away.  Before the Gold Rush, Native Americans outnumbered whites by nearly ten to one." },
    { code:"A", cid:"A5",
      date:"1848-1855",
    ...
    { code:"AU", cid:"A20",
      date:"1870", pic:"NorthAdamsStrikeBreakers.png",
    ...
    { code:"ND", cid:"N82",
      ...
      text:"The Battle of the Little Big Horn. Crazy Horse, Two Moons, and other war chiefs, lead a combined force of twelve to fifteen thousand Teton, Santee and Yankton Sioux, Cheyenne, Arapaho, Gros Ventre, and Assiniboine to successfully resist forced removal to a reservation, killing Custer and about 200 of his Seventh Cavalry. Sitting Bull is present as a medicine man, and Black Elk as a 12 year old boy. [pic: Two Moons]" },
    { code:"N", cid:"N83",
      date:"1877",
    ...
    { code:"B", cid:"B95",
      ...
      text:"First meeting of the Niagara movement, a group of African American intellectuals and activists, led by W. E. B. Du Bois and William Monroe Trotter, calling for opposition to racial segregation and disenfranchisement. The movement is is opposition to policies of accommodation and conciliation promoted by African-American leaders such as Booker T. Washington. [pic: William Trotter]" },
    { code:"A", cid:"A53",
      date:"1905",
    ...
    { code:"B", cid:"B117",
      ...
      text:"In Tulsa Oklahoma, conflict between whites and a group of African Americans gathered to prevent a lynching leaves several dead. Violence escalates, with thousands of whites rampaging through the black community killing people, looting, and destroying real estate. The white mob includes police, and attacks even involve airplanes. The violence leaves 300 dead, over 800 injured and approximately 10,000 homeless." },
    { code:"L", cid:"L39",
      date:"1921-05-19",
    ...
    { code:"NR", cid:"N106",
      date:"1934",
      text:"The Indian Reorganization Act (aka the Wheeler-Howard Act or the Indian New Deal) secures new rights for Native Americans, including Alaskan natives. It reverses the Dawes Act's privatization of common holdings, returns to local self-government on a tribal basis, restores to Native Americans management of their assets such as land, and includes provisions for building a sound economic foundation for Indian reservation inhabitants.\nThe act does not require tribes to select a constitution. However, if the tribe chooses to, the constitution must; (1) allow the tribal council to employ legal counsel, (2) prohibit the tribal council from engaging any land transitions without majority approval of the tribe, and, (3) authorize the tribal council to negotiate with the Federal, State, and local governments. The act slows the practice of assigning tribal lands to individual tribal members, reduces native holdings being lost through checkerboard land sales to non-members, and replaces traditional tribal governance (by consensus) with majority vote. Tribes are urged to adopt more exclusive enrollment requirements, fueling rivalries between traditional and assimilated Native American people." },
    { code:"L", cid:"L45",
      date:"1934",
    ...
    { code:"NU", cid:"N107",
      date:"1945-09-02", pic:"NavajoCodeTalkers.png",
    ...
    { code:"AU", cid:"A96",
      date:"1944-06", pic:"442ndInfantryDUI.png",
    ...
    { code:"LU", cid:"L51",
      date:"1944-03-14", pic:"AztecEaglesP47D.png",
    ...
    { code:"BU", cid:"B136",
      date:"1944-06-06", pic:"761stTankBattalionInsignia.png",
    ...
    { code:"B", cid:"B171",
      ...
      text:"The militant Black Panthers are founded by Huey Newton and Bobby Seale. [pic: Bobby Seale]" },
    { code:"L", cid:"L72",
      date:"1966-06-12",
    ...
    { code:"N", cid:"N122",
      ...
      text:"Four hundred treaties protecting Native Americans have been broken by this year. The newly formed American Indian Movement (AIM), organized in midwestern cities by Dennis Banks, Clyde Bellecourt, and others, represents a militant voice for Native American rights. One program, modeled after the Black Panthers, monitors police. [pic: Dennis Banks]" },
    { code:"AR", cid:"R93",
      date:"1969",
    ...
    { code:"L", cid:"L106",
      ...
      text:"President Bill Clinton names Federico Pena to the position of Secretary of Transportation and names Henry Cisneros to the cabinet position of Secretary of Housing and Urban Development; They are the first Latinos to hold those posts. He also appoints Norma Cantu, to the position of Assistant Secretary for Civil Rights, Department of Education. The president also appoints 25 Hispanics to positions that need confirmation by the Senate. [pic: Henry Cisneros]" },
    { code:"L", cid:"L107",
      date:"1993",
    ...
    { code:"M", cid:"M59",
      date:"2007",
      text:"Preventing Violent Extremism (aka \"Prevent\") is launched in the United Kingdom, targeting Muslims who are perceived as being radicalized through actions such as wearing a headscarf, having a beard, or praying five times a day; all of which are basic principles in Islam. U.S. government officials partner with local police, schools, and hospitals to build Countering Violent Extremism (CVE) programs that threaten American Muslims’ religious self-determination and may violate First Amendment rights by targeting and surveilling people who express criticism towards U.S. policies. Lack of government transparency and accountability, heavy focus on gathering intelligence on Muslim communities and the policing of radical dissent result in diminished youth confidence in democracy. Prevent has also compromised Muslims’ ability to safely use social services, as its “Channel Program” has been extended to the health sector, eroding practices of doctor-patient confidentiality." },
    { code:"B", cid:"B236",
      date:"2007-03-29",
