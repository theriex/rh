app.data = { credit:"Compiled by: Karen L. Suyemoto, Ph.D. - UMass (Boston) Psychology and Asian American Studies. Updated 2005/2006 by Claudia Fox Tree and Elli Stern for EMI Empowering Multicultural Initiatives. Updated 2014 by Emily Davis, for K. Suyemoto.",
  ...
  suppvis:[
    {code:"ly",
     name: "Lynchings",
     intro: "Every data point on this chart is a person who died alone, murdered by a mob, without protection by law enforcement."},
    {code:"pc",
  ...
  pts:[ { code:"NL",
    ...
    { code:"L",
      date:"1760",
      text:"After the Seven Years’ War, which united France and Spain against Britain, France cedes claims to all lands west of the Mississippi in order not to give them to the victorious British. Overnight, New Spain’s territory expands dramatically" },
    { code:"N",
      date:"1763",
    ...
    { code:"L",
      date:"1819",
      text:"Andrew Jackson leads a U.S. military force into FL, capturing 2 Spanish forts. Spain sells FL to the U.S. for $5 million." },
    { code:"N",
      date:"1819",
