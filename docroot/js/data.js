app.data = { credit:"Compiled by: Karen L. Suyemoto, Ph.D. - UMass (Boston) Psychology and Asian American Studies. Updated 2005/2006 by Claudia Fox Tree and Elli Stern for EMI Empowering Multicultural Initiatives. Updated 2014 by Emily Davis, for K. Suyemoto.",
  ...
  pts:[ { code:"NL",
    ...
    { code:"N",
      date:"600",
      text:"After the decline of the Chavín civilization in northern Peru, the Andean regions were dominated by local urban cultures. In the Middle Horizon period (600-1000), a new culture, the Huari-Tiahuanaco dominated the region and enforced cultural conformity. Scholars believe that the architecture and the social and political structure of the Incas ultimately derive from Huari-Tiahuanaco." },
    { code:"L",
      date:"600",
      text:"After the decline of the Chavín civilization in northern Peru, the Andean regions were dominated by local urban cultures. In the Middle Horizon period (600-1000 AD), a new culture, the Huari-Tiahuanaco dominated the region and enforced cultural conformity. Scholars believe that the architecture and the social and political structure of the Incas ultimately derive from Huari-Tiahuanaco." },
    { code:"L",
      date:"700",
    ...
    { code:"B",
      date:"1444",
      text:"Portuguese reach Cape Verde, westernmost point of Africa." },
    { code:"R",
      date:"1492",
      text:"Columbus “discovers” the Americas. Although in the U.S. this is commemorated as Columbus Day, in parts of Latin American, they celebrate El Día de la Raza (the Day of the [New Mixed] Race)." },
    { code:"B",
      date:"1492",
      text:"Blacks are among the first explorers to the New World. Pedro Alonzo Nino, identified by some scholars as a Black man, arrives with Christopher Columbus." },
    { code:"L",
      date:"1492",
      text:"Columbus sails (see Native American chronology)" },
    { code:"N",
      date:"1492",
      text:"Columbus lands on Caribbean island which he names San Salvador. There Native American population is over 5 million." },
    { code:"N",
      date:"1494",
      text:"Columbus initiated the enslavement of Native Americans by Europeans by sending more than 500 of them to Spain to be sold." },
    { code:"L",
      date:"1501-1502",
      text:"East coast of South America surveyed by Amerigo Vespucci.. Portuguese exploration of Brazilian coast." },
    { code:"B",
      date:"1501",
      text:"The Spanish throne officially approves the use of African slaves in the New World." },
    { code:"N",
      date:"1501-1502",
      text:"East coast of South America surveyed by Amerigo Vespucci.. Portuguese exploration of Brazilian coast." },
    { code:"B",
      date:"1502",
      text:"Portugal brings its first shipload of African slaves to the Western Hemisphere, selling them in what is now Latin America." },
    { code:"L",
      date:"1508",
      text:"From Hispaniola, Juan Ponce de León takes Puerto Rico." },
    { code:"L",
      date:"1509",
      text:"From Hispaniola, Juan de Esquivel takes Jamaica, and Alonso de Hojeda leads an expedition to the Venezuelan and Colombian coast." },
    { code:"NL",
      date:"1510",
      text:"Diego Velazquez de Cuellar departs with more than three hundred men to conquer Cuba, and lands at Puerto Escondido. He is successful in defeating Arawak chieftain Hatuey’s guerilla raids" },
    { code:"N",
      date:"1511",
      text:"Sermon of Antonio de Montesinos, O.P., in Santo Domingo, criticizing colonists' treatment of Native Americans." },
    { code:"L",
      date:"1511",
      text:"Sermon of Antonio de Montesinos, O.P., in Santo Domingo, criticizing colonists' treatment of Indians." },
    { code:"NL",
      date:"1511",
      text:"First Spanish town on the American mainland: Santa María la Antigua de Darién. Conquest of Cuba, from Hispaniola." },
    { code:"L",
      date:"1511",
      text:"Real Audiencia de Santo Domingo (the Royal Audiencia of Santo Domingo, first court of the Spanish crown in America) is established by decree of Ferdinand V of Castile." },
    { code:"N",
      date:"1512",
      text:"The Jeronymite Fathers in La Espanola decide to save the decimated Arawak population by gathering them into missions. Soon, missions spread throughout the Spanish Empire." },
    { code:"NL",
      date:"1512",
      text:"Laws of Burgos, the first code regulating Spanish treatment of Native People." },
    { code:"N",
      date:"1512",
      text:"Arrival of first bishop (of Caparra, Hispaniola) in America." },
    { code:"L",
      date:"1512",
      text:"Arrival of first bishop (of Caparra, Hispaniola) in America. " },
    { code:"L",
      date:"1512",
      text:"The Jeronymite Fathers in La Espanola decide to save the decimated Arawak population by gathering them into missions. Soon, missions spread like wildfire throughout the Spanish Empire." },
    { code:"L",
      date:"1513",
      text:"Juan Ponce de León “claims” Florida for Spain. " },
    { code:"N",
      date:"1513",
      text:"Juan Ponce de León claims Florida for Spain." },
    { code:"L",
      date:"1513",
      text:"Vasco Núñez de Balboa crosses the Isthmus of Panama to the Pacific." },
    { code:"B",
      date:"1526",
      text:"The first group of Africans to set foot on what is now the U.S., are brought by a Spanish explorer to SC to erect a settlement. However, they soon flee to the interior and settle with Native Americans." },
    { code:"B",
      date:"1562",
    ...
    { code:"B",
      date:"1600",
      text:"By the year 1600, over 900,000 slaves have been brought to Latin America. In the next century, 2,750,000 are added to that total. Slave revolts in the 16th century are reported in Hispaniola, Puerto Rico, Panama, Cuba, and Mexico." },
    { code:"N",
      date:"1600’s",
    ...
    { code:"N",
      date:"1607",
      text:"Jamestown is founded." },
    { code:"R",
      date:"1614",
      text:"The first recorded interracial marriage in North American history between John Rolfe and Pocahontas." },
    { code:"N",
      date:"1616",
      text:"The English in VA, unable to raise their own food, tried to collect tribute from Native Americans, but the Chickahominy refused. The English invaded, captured, and killed several leaders, and forced the payment of tribute." },
    { code:"N",
      date:"1620",
      text:"Pilgrims land in Plymouth. MA." },
    { code:"N",
      date:"1622",
      text:"First major Native American retaliation. Chief Opechancanough of the Powhatan Confederacy, led the assault on the nearly 350 English settlers around Jamestown, Virginia." },
    { code:"B",
      date:"1629-1637",
      text:"African slaves are imported into CT, MD, and New Amsterdam (now New York)." },
    { code:"R",
      date:"1630",
    ...
    { code:"L",
      date:"1630-1654",
      text:"Dutch occupation of north-east Brazil." },
    { code:"N",
      date:"1637",
      text:"Pequot War between Pequots and European settlers, aided by some other Native American nations." },
    { code:"LB",
      date:"1640",
      text:"Beginning of large-scale sugar planting in non-Spanish Caribbean islands" },
    { code:"B",
      date:"1641",
      text:"MA becomes the first colony to legalize slavery." },
    { code:"N",
      date:"1649",
      text:"The English Assembly at Jamestown (VA) ordered that Native American town boundaries be clearly marked and defined. This was a device whereby the whites would not have to recognize Native American title to any lands beyond the town boundaries." },
    { code:"B",
      date:"1651",
    ...
    { code:"N",
      date:"1661",
      text:"Spanish authorities raid Pueblo kivas (sacred ceremonial chambers) and destroyed hundreds of sacred Kachina masks and other sacred objects in an effort to destroy Native American “religion.”" },
    { code:"R",
      date:"1662",
      text:"Virginia is the first state (actually, a colony at this time) to establish anti-miscegenation laws because “sexual intercourse between a White and a Black was twice as evil as fornication between two White adults.” If law was broken, punishment could have been a public whipping." },
    { code:"B",
      date:"1663",
      text:"MD settlers pass a law stipulating that all imported Africans are to be given the status of slaves. Free White women who marry Black slaves are also considered slaves during the lives of their spouses; children of such unions are also to be classified as slaves. In 1681, a law is passed which stipulates that children born from a union of a White servant woman and African are free citizens." },
    { code:"R",
      date:"1664",
      text:"The first anti-miscegenation law in Maryland is passed." },
    { code:"N",
      date:"1675-1676",
      text:"Southern New England Nations/tribes tried to halt English expansion. Metacomet gathered some 20,000 Native Americans who fought for a year against the New England colonists, but failed to win back their country. King Philip’s War was one of the bloodiest and most costly in the history of America. One in ten soldiers on both sides was injured or killed. Hundreds of Natives who fought with Philip were sold into slavery abroad. Others, especially women and children, were forced to become servants locally." },
    { code:"N",
      date:"1675",
      text:"Captain Benjamin Church of the Plymouth Colony militia led colonial forces against the Narragansetts in RI who were slaughtered or sold into slavery." },
    { code:"N",
      date:"1680-1683",
      text:"Aided by some Shawnee, the English in SC destroyed all but fifty of their allies, the Westos, in order to get slaves and better access to the interior. The survivors eventually joined the Creek." },
    { code:"N",
      date:"1680",
      text:"The Pueblo Rebellion, incited by eighty years of harsh treatment by the Spanish, results in the massacre of over four hundred soldiers, officers, and priests; the Southwest reverts to Native American country until 1692 when it is reconquered." },
    { code:"N",
      date:"1681",
      text:"William Penn’s “Noble Experiment”, the Quaker policy treating Native Americans fairly in the colony of Pennsylvania, lasts about 40 years." },
    { code:"B",
      date:"1688",
      text:"Mennonites in PA sign an anti-slavery resolution, the first formal protest against slavery in the Western Hemisphere." },
    { code:"N",
      date:"1691",
      text:"English people who married Native Americans, Blacks, or mulattos are banished from VA." },
    { code:"R",
      date:"1691",
    ...
    { code:"R",
      date:"1705",
      text:"Massachusetts follows VA and prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"B",
      date:"1711",
      text:"The colonial legislature in PA, after being pressured from the Mennonites and Quakers, outlaws slavery in PA but is overruled by the British Crown." },
    { code:"B",
      date:"1712",
      text:"The Maiden Lane slave revolt in NY city claims the lives of 9 Whites and results in the execution of 21 Black slaves. Six others commit suicide." },
    { code:"R",
      date:"1715",
    ...
    { code:"N",
      date:"1717-1718",
      text:"The English, French, and Spanish all tried to win over the Creek confederacy to secure its trade, but the Creek were not dominated by any European groups and became a powerful independent force." },
    { code:"R",
      date:"1724",
    ...
    { code:"B",
      date:"1750",
      text:"The Black slave population in the English Colonies reaches 236,400 with over 206,00 living south of PA. Slaves comprise about 20% of the colonies’ population." },
    { code:"N",
      date:"1750’s",
      text:"Distilled liquor (fire water) is used by traders to entice agreements." },
    { code:"R",
      date:"1750",
      text:"Georgia prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"B",
      date:"1754",
      text:"Benjamin Banneker, a 22-year old free Black man, becomes the first person in the North American colonies to construct a clock." },
    { code:"L",
      date:"1760",
      text:"After the Seven Years’ War, which united France and Spain against Britain, France ceded claims to all lands west of the Mississippi in order not to give them to the victorious British. Overnight, New Spain’s territory expands dramatically" },
    { code:"N",
      date:"1763",
      text:"The Ottawa leader Pontiac, and his pan-Native American confederacy, launched its attack on the English in the Great Lakes region with a surprise assault on Detroit. The alliance captured all British forts west of Niagara except for Fort Detroit and Fort Pit (Pittsburgh). At General Jeffrey Amherst’s suggestion, Henry Bouquet ordered the distribution of smallpox-infected blankets to the Native Americans near Fort Pitt." },
    { code:"N",
      date:"1763",
      text:"The British proclaim a boundary line between their “civilization” and “Native American Territory”— defined as “any lands beyond the heads or sources of any of the rivers which fall into the Atlantic Ocean from the West or Northwest.” By 1840, this line, inherited by the U.S., the Permanent Boundary, separates white controlled, “civilized” lands from the “Great American Desert”. It runs approximately from the Gulf of Mexico to Lake Michigan via the Mississippi River." },
    { code:"A",
      date:"1763",
    ...
    { code:"N",
      date:"1765",
      text:"Pontiac signs peace treaty with the British." },
    { code:"L",
      date:"1766",
      text:"The presidio of San Francisco is founded, becoming Spain’s northernmost frontier outpost." },
    { code:"B",
      date:"1769",
      text:"In the VA house of Burgesses, Thomas Jefferson unsuccessfully presses for a bill to emancipate African slaves." },
    { code:"N",
      date:"1769-1834",
      text:"The first Spanish mission is constructed in California. By 1830, disease, brutality and other dietary and cultural changes had reduced the coastal native population from seventy thousand to twenty-four thousand. By 1840, six thousand Mission Native Americans were left, most of them serfs on large ranches." },
    { code:"B",
      date:"1770",
      text:"The Quakers open a school for Blacks in Philadelphia, PA." },
    { code:"B",
      date:"1773",
      text:"The first Baptist Church for Blacks is organized in Savannah, GA." },
    { code:"B",
      date:"1774",
      text:"The Continental Congress demands elimination of the trans-Atlantic slave trade and economic embargoes on all countries participating in it. RI enacts a law prohibiting slavery (not applying to slaves already in RI before 1774)." },
    { code:"N",
      date:"1775",
      text:"Massachusetts legislation was signed that promised a bounty for every male “Indian” scalp obtained." },
    { code:"B",
      date:"1775",
      text:"The first abolitionist society in the U.S. is organized in Philadelphia, PA." },
    { code:"B",
      date:"1775",
      text:"The Continental Congress bars Blacks from serving the army during the American Revolution. When the British governor of VA offers freedom to all male slaves who join the loyalist forces, General George Washington reverses his position and orders acceptance of free Blacks for military service." },
    { code:"N",
      date:"1775",
      text:"The first of 374 treaties is signed, recognizing the rights of Native Americans to land they occupy (the last, in 1869, forced Chief Joseph and his Nez Perce people off their lands)." },
    { code:"L",
      date:"1776",
      text:"Declaration of Independence in the United States." },
    { code:"B",
      date:"1776",
      text:"The amended form of the Declaration of Independence, which does not include Jefferson’s proposal denouncing slavery, is adopted." },
    { code:"N",
      date:"1776",
      text:"Signing of the Declaration of Independence. The rationales for separating from England included that the King was inciting Indian attacks." },
    { code:"N",
      date:"1776-1860’s",
    ...
    { code:"N",
      date:"1779",
      text:"George Washington, because of his scorched earth campaign against Iroquois towns, becomes known as the \"town destroyer\". Upon his inauguration, he is the richest man in the new U.S., based on taking advantage of Indian land deals." },
    { code:"R",
      date:"1780",
      text:"Pennsylvania legalizes interracial marriage." },
    { code:"B",
      date:"1780",
      text:"The PA assembly enacts a law providing for the gradual emancipation of slaves." },
    { code:"B",
      date:"1783",
      text:"Slavery in MA is abolished by the MA Supreme Court. Blacks in taxable categories are granted suffrage." },
    { code:"N",
      date:"1783",
      text:"American Revolutionary War ends." },
    { code:"R",
      date:"1784",
    ...
    { code:"B",
      date:"1787",
      text:"Congress passes the Northwest Ordinance which forbids the extension of slavery into this area." },
    { code:"B",
      date:"1787",
    ...
    { code:"N",
      date:"1787",
      text:"The Northwest Ordinance created the basis for the settlement of whites beyond the Alleghenies. It provided that the Native Americans’ land should never be taken from them without their consent." },
    { code:"N",
      date:"1789",
      text:"The U.S. War Department is created, in part, to handle all Native American matters." },
    { code:"A",
      date:"1790",
      text:"First U.S. Naturalization Act allows only “free white persons” to become American citizens First recorded arrival of Asian Indians in the U.S." },
    { code:"B",
      date:"1790",
    ...
    { code:"N",
      date:"1791",
      text:"Nations/tribes in Ohio led by Miami Little Turtle annihilated the army of General Arthur Saint Clair, Governor of the Northwest Territory, near present-day Fort Wayne, Indiana." },
    { code:"RR",
      date:"1792",
      text:"Kentucky prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"B",
      date:"1793",
      text:"Eli Whitney patents the cotton gin, which strengthens slavery by increasing profits in growing cotton. Congress passes the Fugitive Slave Act, which makes it a criminal offense to harbor a slave or prevent his or her arrest." },
    { code:"B",
      date:"1793",
      text:"VA passes a law which forbids free Blacks from entering the state." },
    { code:"N",
      date:"1795",
    ...
    { code:"L",
      date:"1800's",
      text:"Cuban and Puerto Rican tabaqueros work in Boston in the 19th century as shop owners, factory, or farm workers. The South End Latino community is largely a bachelor society." },
    { code:"B",
      date:"1800",
      text:"Congress rejects a petition to free Blacks in PA to gradually end slavery in the U.S." },
    { code:"M",
      date:"1800",
      text:"Maronite Christians from Lebanon, Armenians, and other Christian minorities from the Ottoman Empire began settling in the United States in significant number due to religious persecution." },
    { code:"M",
      date:"1800",
      text:"First major wave of Arab immigration due to civil wars. The majority were Christians. Syrians, Lebanese, and Palestinians were the first pioneers who landed in Manhattan, NY" },
    { code:"N",
      date:"1803",
      text:"U.S. Louisiana purchase for $15 million." },
    { code:"L",
      date:"1803",
      text:"France acquires the Louisiana Territory from Spain, which was ceded during the Seven Years’ War. Napoleon sells the vast territory to the U.S., expanding the borders of the infant nation to connect directly with New Spain" },
    { code:"B",
      date:"1803",
      text:"The SC state legislature, which had been trying limit importation of slaves, reopens the slave trade with Latin American and the West Indies." },
    { code:"B",
      date:"1804",
      text:"NJ passes an emancipation law. All states north of the Mason-Dixon Line now have laws forbidding slavery or providing for its gradual elimination." },
    { code:"N",
      date:"1804",
      text:"Over the course of the Lewis and Clark Expedition, the Corps of Discovery would come into contact with nearly 50 Native American Nations/tribes with diverse language, culture, and experiences with Europeans." },
    { code:"R",
      date:"1807",
    ...
    { code:"R",
      date:"1808",
      text:"The Louisiana Civil Code prohibits \"free people of color\" from marrying Blacks or Whites." },
    { code:"B",
      date:"1810",
    ...
    { code:"N",
      date:"1811",
      text:"Native Americans defeated in Battle of Tippecanoe in Indiana Territory" },
    { code:"N",
      date:"1812",
      text:"First Seminole War" },
    { code:"N",
      date:"1814",
      text:"Creek Native American War" },
    { code:"B",
      date:"1816",
      text:"The African Methodist Episcopal Church is organized in Philadelphia, PA." },
    { code:"B",
      date:"1817",
      text:"Mississippi enters the union as a slave state. NY passes a gradual slavery abolition act." },
    { code:"R",
      date:"1818",
    ...
    { code:"L",
      date:"1819",
      text:"When Andrew Jackson leads a U.S. military force into FL, capturing 2 Spanish forts, Spain sells FL to the U.S. for $5 million." },
    { code:"N",
      date:"1819",
    ...
    { code:"R",
      date:"1820's-1860's",
      text:"John Ross, only one-eighth Cherokee by blood, utilized his knowledge of the White man’s system to fight against outside encroachment on his tribe’s property and forced removal of his people from the Southeast to Indian territory" },
    { code:"B",
      date:"1820",
    ...
    { code:"L",
      date:"1821",
      text:"New Spain acquires independence from Spain, naming their nation the Republic of Mexico. By this time, Spanish colonies exist in coastal CA, southern AZ, south TX, and in most of NM and southern CO. Soon after Mexico gains independence, Anglo-American settlers begin to move into the Mexican territories of the present day U.S. Southwest, especially Texas" },
    { code:"R",
      date:"1821",
      text:"Maine prohibits intermarriage between Whites and Negroes, Indians, or mulattos." },
    { code:"B",
      date:"1822",
      text:"The Denmark Vesey conspiracy in Charleston, SC, one of the most elaborate slave revolts on record, fails. Vesey and 36 collaborators are hanged. In response, slave states adopt laws to further restrict the mobility of Blacks." },
    { code:"R",
      date:"1822",
    ...
    { code:"N",
      date:"1824",
      text:"The War Department subsumes the newly created Bureau of Native American Affairs." },
    { code:"B",
      date:"1826",
    ...
    { code:"N",
      date:"1831",
      text:"Nat Turner leads a slave rebellion, inspiring fear of Native Americans and Blacks." },
    { code:"B",
      date:"1831",
      text:"Nat Turner leads the greatest slave rebellion in history. Some 60 Whites are killed in VA and the entire South is thrown into panic. Turner is hanged." },
    { code:"R",
      date:"1832",
      text:"Florida prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"N",
      date:"1832",
      text:"In Worcester v. Georgia, the third case of the trilogy, the court holds that tribal sovereign powers were not relinquished when Native American Nations/tribes exchanged land for peace or protection." },
    { code:"B",
      date:"1834",
    ...
    { code:"N",
      date:"1835",
      text:"Second Seminole War in Florida" },
    { code:"B",
      date:"1836",
      text:"U.S. House of Rep. adopts the “gag rule,” which prevents congressional action on anti-slavery resolutions of legislation." },
    { code:"L",
      date:"1836",
      text:"The Anglo settlers declare the Republic of Texas independent of Mexico. The Texas constitution stipulates that all residents living in TX at the time of the rebellion will acquire the rights of citizens of the new republic, but if they had been disloyal, these rights are forfeited. Numerically superior Anglos force Mexicans off their property and many cross over the border to Mexico" },
    { code:"R",
      date:"1836",
    ...
    { code:"B",
      date:"1841",
      text:"Throughout the country, increasingly restrictive segregation statutes are enacted. NY grants schools the right to segregate education. SC forbids White and Black mill hands from looking out the same window. Whites and Blacks in Atlanta are required to swear on different Bibles in court." },
    { code:"N",
      date:"1842",
      text:"Seminoles moved to Native American Territory" },
    { code:"N",
      date:"1842",
      text:"The opening of the Oregon Trail, the first interstate highway, brings thousands of settlers, with cattle, wagons, and other environmental effects that disrupt the buffalo migrations and spread disease." },
    { code:"R",
      date:"1843",
      text:"Massachusetts legalizes interracial marriage." },
    { code:"B",
      date:"1843",
      text:"MA and VT state legislatures defy the Fugitive Slave Act and forbid state officials from imprisoning or assisting federal authorities in the recapture of escaped slaves." },
    { code:"L",
      date:"1845",
      text:"TX is officially annexed to the U.S." },
    { code:"B",
      date:"1845",
      text:"U.S. Congress overturns the gag rule. Texas is admitted to the Union as a slave state." },
    { code:"N",
      date:"1845-1870",
      text:"Before the gold rush, Native Americans outnumbered whites by nearly ten to one. In the quarter century between 1845 and 1870, the California Native Americans population had declined from approximately 150,000 (which was only half the number of Native Americans before white contact) to 30,000. Between 1848 and 1880, whites killed at least 4,500 Native Americans. These numbers do not include the Native Americans who were driven away, died by disease, or starved to death. Exploitation of the Native Americans labor force in mines, destruction of their food supply by hunting and mining, and murder for racial and economic motives were the main reasons for the severe decline of the Native Americans." },
    { code:"L",
      date:"1846",
      text:"The U.S. invades Mexico under the banner of Manifest Destiny. The treaty of Guadalupe Hidalgo ends the Mexican War that same year. Under the treaty, half the land of Mexico is transferred to the U.S., including TX, CA, most of AZ and NM and parts of CO, UT and NV. The treaty gives Mexican nationals one year to choose U.S. or Mexican citizenship. 75,000 Hispanic people choose to remain in the U.S. and become citizens by conquest." },
    { code:"A",
      date:"1847",
      text:"Three Chinese boys enrolled at Monson Academy in SW Massachusetts. One of them, Yung Wing, went to Yale and became the first Chinese grad of a major college in 1854." },
    { code:"B",
      date:"1848",
      text:"Roberts v. the City of Boston. Benjamin Roberts, an African American father sued the city of Boston to allow his five year old daughter to attend a school closer to her home. This lawsuit was part of an organized effort by the African American community to end racially segregated schools. When the Massachusetts Supreme Judicial Court ruled against Sarah Roberts the ideology of “separate but equal” was born. The case was defended by Robert Morris who was the first Black lawyer in America to argue a jury case. \nAlthough the case lost in the courts. the Black community was determined and did not give up the fight. The Black-led Equal School Association began to look towards legislature to end segregated public schools. With the unwavering efforts of the Black community, through boycotts, protests and the support of White allies a victory was finally achieved. In 1855, a law abolishing school segregation was passed. Boston became the first major city in America to open its public schools to African Americans. This successful effort led to other victories such as the opening of theaters and railway cars, the opening of government jobs, a memorial honoring Crispus Attucks and the formation of African American Union regiments to fight in the Civil War." },
    { code:"A",
      date:"1848",
      text:"Discovery of gold in California.  Chinese begin to arrive, some as indentured servants, during the CA Gold Rush. The bulk of these immigrants later become a source of cheap labor for railroads, mines, fisheries, farms, etc." },
    { code:"N",
      date:"1849-1885",
      text:"Buffalo decimation. By 1885 the two great herds of 15 million buffalo are almost exterminated by white hunters seeking hides for money" },
    { code:"B",
      date:"1849",
      text:"Harriet Tubman escapes from slavery in MD. She later returns to the South no less than 19 times to help transport more than 300 slaves to freedom." },
    { code:"A",
      date:"1850",
      text:"A Japanese man, Hikozo Hamada (Joseph Heco) is rescued at sea by an American sailing ship. He studies in Baltimore, MD, and becomes the first Japanese naturalized as an American citizen" },
    { code:"R",
      date:"1850",
      text:"California prohibits intermarriage between Whites and Negroes or mulattos. In 1880, they will expand the law to include \"Mongolians\"" },
    { code:"R",
      date:"1850-1860",
    ...
    { code:"A",
      date:"1850",
      text:"San Francisco’s Chinatown was established and began to grow. The number of Chinese in California grows from 3 in 1848 to 3000 in 1850." },
    { code:"N",
      date:"1851",
      text:"The Treaty of Fort Laramie with the Plains Native Americans defined their territories. In return for ending hostilities, Native Americans were promised annuities, later cut down by the U.S. Senate. All Sioux land in Iowa is given to the United States" },
    { code:"R",
      date:"1851",
    ...
    { code:"N",
      date:"1854",
      text:"Indian Appropriation Act: Congress has the authority to establish reservations (move specific nations to specific places-mostly south central area (representing Oklahoma)." },
    { code:"N",
      date:"1854",
    ...
    { code:"B",
      date:"1855",
      text:"MA abolishes school segregation." },
    { code:"L",
      date:"1855",
    ...
    { code:"L",
      date:"1857",
      text:"Anglos businessmen attempt to run off Mexican teamsters in south Texas, violating the guarantees offered by the treaty of Guadelupe Hidalgo" },
    { code:"B",
      date:"1857",
      text:"Supreme Court rules on the Dred Scott case. On March 6, the Supreme Court decides that an African American cannot be a citizen of the U.S. and thus has no rights of citizenship. The decision sharpens the national debate over slavery." },
    { code:"R",
      date:"1857",
      text:"New Mexico prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"B",
      date:"1859",
      text:"During this year, the last ship to bring slaves to the U.S., the Clothilde, arrives in Mobile Bay, Alabama." },
    { code:"A",
      date:"1859",
      text:"Chinese are excluded from public schools in San Francisco" },
    { code:"B",
      date:"1859-10-16",
      text:"John Brown raids the federal arsenal at Harper’s Ferry, Virginia. Brown’s unsuccessful mission to obtain arms for a slave insurrection stirs and divides the nation. Brown is hanged on December 2." },
    { code:"A",
      date:"1860",
      text:"First Japanese delegation visits Washington, D.C." },
    { code:"B",
      date:"1860",
      text:"As the Civil War approaches, the U.S. is sharply divided. VA passes a law stipulating that free Blacks can be sold into slavery for committing imprisonable offenses. MD forbids emancipation of slaves. President Buchanan advocates a constitutional amendment confirming the fugitive slave acts. Lincoln is elected president. SC secedes from the Union." },
    { code:"R",
      date:"1861",
      text:"In response to Chinese immigration, Nevada passes the first anti-miscegenation laws explicitly targeting Asian Americans, prohibiting marriage between Blacks, mulattos, Indians, and Chinese. Other western states follow the next few decades." },
    { code:"N",
      date:"1861",
    ...
    { code:"R",
      date:"1861",
      text:"Mulattos form a Negro regiment to defend Louisiana but are disarmed by White officers." },
    { code:"B",
      date:"1861",
      text:"Civil War." },
    { code:"R",
    ...
    { code:"L",
      date:"1862",
      text:"Homestead Act is passed in Congress, allowing squatters in the West to settle and claim vacant lands, often those owned by Mexicans" },
    { code:"N",
      date:"1862",
      text:"The Homestead Act brings vast numbers of settlers on to public domain lands in KS and NE. Many settled on land belonging to Native American Nations/tribes and were certified as owners of the illegally taken land." },
    { code:"B",
      date:"1862",
    ...
    { code:"R",
      date:"1862",
      text:"Oregon prohibits intermarriage between Whites and Negroes, Indians, or mulattos. In 1866 they expand this to include Chinese, and in 1893 they include all Mongolians." },
    { code:"N",
      date:"1863",
      text:"Beginning in 1863 Christopher \"Kit\" Carson begins an economic war against the Navajo, leading marches through Navajo country to destroy crops, orchards, and livestock, leaving the Navajo vulnerable to attacks from the Utes, Pueblos, Hopis, and Zunis (Navajo traditional enemies)." },
    { code:"R",
      date:"1863",
      text:"West Virginia prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"B",
      date:"1863",
      text:"Lincoln’s Emancipation Proclamation takes effect January 1, legally freeing slaves in areas of the South in rebellion." },
    { code:"B",
      date:"1863-07-18",
    ...
    { code:"A",
      date:"1863",
      text:"Recruiting begins for Chinese laborers for the Central Pacific Railroad. Chinese workers were essential to the completion of the transcontinental railroad but excluded from the final ceremonies." },
    { code:"B",
      date:"1864",
      text:"On June 15, Congress passes a bill authorizing equal pay, equipment, arms, and health care for African American troops." },
    { code:"N",
      date:"1864",
      text:"Most Navajo surrender to Carson, who forces the “Long Walk” where 8,000 men, women, and children are marched 300 miles from Arizona to New Mexico. They were imprisoned until 1868, and then allowed to return to their homeland, now reduced to 1/5 the size of the original territory" },
    { code:"N",
      date:"1864",
      text:"The Sand Creek massacre: over two hundred Cheyenne in Colorado are killed by the Cavalry." },
    { code:"R",
      date:"1864",
    ...
    { code:"B",
      date:"1865",
      text:"The Confederacy surrenders. (Of the 179,000 Blacks who served in the Union army, 3,000 were killed in battle, 26,000 died from disease, and 14,700 deserted. Blacks represented 9-10% of the Unions armed forces.)" },
    { code:"R",
      date:"1865",
    ...
    { code:"B",
      date:"1865",
      text:"The 13th Amendment abolishing slavery is ratified." },
    { code:"B",
      date:"1865",
      text:"Lincoln is assassinated." },
    { code:"B",
      date:"1866-02-02",
      text:"A Black delegation led by Frederick Douglass meets with president Andrew Johnson at the White House to advocate Black suffrage. The president expresses his opposition, and the meeting ends in controversy." },
    { code:"B",
      date:"1866",
    ...
    { code:"B",
      date:"1867",
      text:"Reconstruction begins. Congress passes Reconstruction Acts. These acts call for the enfranchisement of former slaves in the South." },
    { code:"N",
      date:"1867",
      text:"The U.S. buys Alaska from Russia." },
    { code:"B",
      date:"1868",
      text:"The 14th Amendment is ratified, establishing the concept of “equal protection: for all citizens under the Constitution. President Johnson vetoes the bill granting vote to Blacks in Washington, DC--the veto is overridden by Congress." },
    { code:"B",
      date:"1868-09-28",
      text:"An estimated 200 to 300 Black Americans are killed in Lousiana in the Opelousas Massacre." },
    { code:"L",
      date:"1868",
      text:"A decree in Puerto Rico frees all children born of slaves after this date. " },
    { code:"A",
      date:"1868",
      text:"The U.S. ratifies the Burlingame Treaty with China, recognizing the right of Chinese to immigrate for “purpose of curiosity, trade, or permanent residence,” but expressly restricts the right of naturalization." },
    { code:"L",
      date:"1868",
      text:"Cubans leave for Europe and the U.S. in sizable numbers during Cuba’s first major attempt at independence" },
    { code:"B",
      date:"1868",
      text:"9 states grant suffrage to Blacks, but 2 deny it." },
    { code:"R",
      date:"1868",
      text:"Washington legalizes interracial marriage." },
    { code:"R",
      date:"1868",
      text:"Rhode Island legalizes interracial marriage." },
    { code:"A",
      date:"1868",
      text:"About 149 Japanese contract workers arrive in HI to work the sugar plantations" },
    { code:"N",
      date:"1868",
    ...
    { code:"L",
      date:"1868",
      text:"14th Amendment is adopted, declaring all people of Hispanic origin born in the U.S. as U.S. citizens" },
    { code:"N",
      date:"1869-1876",
      text:"200 pitched battles between Native Americans and U.S. Cavalry" },
    { code:"A",
      date:"1869",
    ...
    { code:"R",
      date:"1870+",
      text:"The U.S. Government, seeks the signatures of mixed blood Indians to satisfy the three-fourths approval of tribal adult males prerequisite to the distribution. In a later reversal of stance, when strong antigovernment stances by tribes were partially instigated by mixed bloods or when the U.S. government wanted to cut expenditures for Native Americans, the government has tried to categorize as non-Indian those with lesser blood quantum (less than one-half blood quantum)." },
    { code:"L",
      date:"1870",
      text:"All slaves who are state property are freed, as are various other classes of slaves." },
    { code:"R",
      date:"1870",
      text:"1870, 1880 Census Mulattos are officially defined to include \"quadroons, octoroons, and all persons having any perceptible trace of African blood.\"" },
    { code:"A",
      date:"1870",
      text:"Naturalization Act” excludes Chinese from citizenship and prohibits entry of wives of laborers (1910). Nationwide recession causes West Coast labor problems. Mobs destroy Chinese communities in many areas of CA and other states." },
    { code:"A",
      date:"1870",
      text:"63,199 Chinese in continental U.S., 99.4% in western states/territories, 78% in California." },
    { code:"A",
      date:"1870",
      text:"Owner of North Adams, MA factory is the first to bring Chinese laborers to break a strike." },
    { code:"A",
      date:"1870",
    ...
    { code:"N",
      date:"1871",
      text:"Congress ends treaty making with the Indian Appropriation Act.. Simultaneously, Congress voices its responsibility to honor all already \"lawfully made\" treaties." },
    { code:"N",
      date:"1874",
      text:"Gold is verified in the Black Hills by Custer's expedition." },
    { code:"N",
      date:"1874",
      text:"The federal government breaks the Fort Laramie Treaty to remove the Black Hills from Native American control, a reduction of the reservation to one quarter the original size." },
    { code:"R",
      date:"1874",
      text:"Illinois legalizes interracial marriage." },
    { code:"A",
      date:"1875",
      text:"Page Law prohibits entry of Chinese, Japanese, and “Mongolian” prostitutes. The law requires proof of “good character” for entry and is widely applied to all Chinese women, contributing to a gender imbalance that reaches a ratio of 27 Chinese men to every one Chinese woman in the U.S. by 1890." },
    { code:"B",
      date:"1875",
      text:"Congress passes civil rights legislation guaranteeing equal rights to Black Americans in public accommodations and jury duty. The legislation was invalidated by the Supreme Court in 1883" },
    { code:"B",
      date:"1875",
    ...
    { code:"B",
      date:"1875",
      text:"On September 4-6, more than 20 Black Americans are killed in a massacre in Clinton, Mississippi." },
    { code:"A",
      date:"1876+",
      text:"Economic collapse in U.S. leads to anti-Chinese violence in California." },
    { code:"N",
      date:"1876",
      text:"The Battle of the Little Big Horn, led by Crazy Horse, Two Moons, and other war chiefs, a combined force of between twelve and fifteen thousand Teton, Santee and Yankton Sioux, Cheyenne, Arapaho, Gros Ventre, and Assiniboine successfully resist forced removal to a reservation and kill Custer and about 200 of his Seventh Cavalry. Sitting Bull is present as a medicine man, and Black Elk as a 12 year old boy." },
    { code:"N",
      date:"1877",
    ...
    { code:"B",
      date:"1877",
      text:"The end of Reconstruction. A deal with Southern Democratic leaders makes Rutherford B. Hayes (Republican) president, in exchange for the withdrawal of federal troops from the South and the end of federal efforts to protect the civil rights of African Americans." },
    { code:"N",
      date:"1877-09-28",
    ...
    { code:"N",
      date:"1877",
      text:"Crazy Horse is murdered by Native American police, instigated by the U.S. government." },
    { code:"N",
      date:"1877",
      text:"Chief Joseph and his Nez Perce people surrender at Bear Paw Mountain in Montana. Nez Perce leave Idaho for Canada" },
    { code:"L",
      date:"1878",
      text:"The Ten Years’ War, in which Spanish attempts to evict rebels from the eastern half of Cuba were unsuccessful, comes to an end with signing of the Pact of El Zajon, promising amnesty for the insurgents and home rule, and provides freedom for the slaves that fought on the side of the rebels" },
    { code:"N",
      date:"1878",
      text:"U.S. government establish Native American police forces for reservation supervision." },
    { code:"B",
      date:"1878",
    ...
    { code:"N",
      date:"1879",
      text:"Captain Richard Henry Pratt founded Carlisle Native American School in Penn with the aim to immerse Native Americans in European American culture. During vacations Pratt sent students to live and work with white families to increase assimilation." },
    { code:"A",
      date:"1879",
      text:"Hong Far Low Restaurant, believed to be first in Boston, is established." },
    { code:"A",
      date:"1879",
      text:"The second Constitution of California adopted this year contains many discriminatory provisions against Chinese: (1) Chinese immigrants are denied naturalization; (2) corporations are not allowed to hire Chinese; (3) Chinese are forbidden to be employed in public works except as punishment for crimes; (4) recruitment of Chinese laborers is considered as coolie trade and made illegal; (5) State Legislature is to assist the removal of Chinese to regions beyond the limits of cities and towns." },
    { code:"A",
      date:"1879",
      text:"Congress passes law to limit ships to carry no more than 15 Chinese passengers each." },
    { code:"A",
      date:"1880",
      text:"Treaty between U.S. and Chinese gives the U.S. the right to limit Chinese immigration. New York City’s Chinatown is established." },
    { code:"N",
      date:"1880’s",
    ...
    { code:"R",
      date:"1881-1906",
      text:"Compilation of the Devil's Dictionary, in which Mulatto is defined as \"n. A child of two races, ashamed of both.\"" },
    { code:"A",
      date:"1881-1892",
      text:"Four female Chinese students obtain medical degrees from U.S. universities" },
    { code:"A",
      date:"1882",
      text:"Major violent attacks on Chinese communities in Wyoming" },
    { code:"A",
      date:"1882",
      text:"The Chinese Exclusion Act prohibits entrance of Chinese laborers, and prohibits courts from issuing citizenship. It was intended to last for only 10 years but was later extended until 1902 and again extended indefinitely in various forms under various names until it was negated in 1943." },
    { code:"A",
      date:"1882",
      text:"The “Chinese Must Go” movement gains momentum: Chinese immigration to the U.S. declined from 39,500 in 1882 to only 10 in 1887." },
    { code:"A",
      date:"1882",
    ...
    { code:"B",
      date:"1883",
      text:"The United States Supreme Court declares the Civil Rights Act of 1875 unconstitutional." },
    { code:"A",
      date:"1885",
    ...
    { code:"A",
      date:"1885",
      text:"Major violent attacks on Chinese communities in Washington" },
    { code:"N",
      date:"1886",
      text:"Geronimo (Apache) surrenders after 15 years" },
    { code:"N",
      date:"1886",
    ...
    { code:"R",
      date:"1887",
      text:"Allotment Act - Federal Act which implements \"blood quantum\" restrictions as well as formal enrollment into Native American tribes." },
    { code:"A",
      date:"1887",
      text:"Major violent attacks on Chinese communities in Oregon" },
    { code:"N",
      date:"1887",
      text:"The General Allotment or Dawes Act, introduces private ownership of land to Native Americans, breaking up tribally-owned lands and dividing them among individuals, with the “surplus” sold to whites, sometimes at very low prices, by public officials. 118 reservations were divided; 38 million acres taken outright by the government, and 22 million declared 'surplus' and opened for settlement. An additional 23 million acres were sold between 1887 and 1934 by Native Americans in order to alleviate poverty or pay debts (including taxes on the now individually held land). In total, the Allotment Act cost Native Americans almost two-thirds of the land they had owned in 1887." },
    { code:"R",
      date:"1887",
      text:"Ohio legalizes interracial marriage." },
    { code:"A",
      date:"1888",
      text:"Congress passes the Scott Act, which bars the re-entry of Chinese laborers who have left the U.S. for temporary visits to China (permitted under the Exclusion Act). Over 20,000 Chinese laborers with re-entry permits are denied return to the U.S." },
    { code:"A",
      date:"1889",
    ...
    { code:"N",
      date:"1890",
      text:"The U.S. government again changes the treaty to reduce the Sioux Reservation to about 1/5 its original size." },
    { code:"M",
      date:"1890",
      text:"Syrians and Lebanese began to move west. Some were attracted to Arizona during a mining boom." },
    { code:"N",
      date:"1890",
    ...
    { code:"B",
      date:"1890",
      text:"Mississippi constitutional convention begins the systematic exclusion of Blacks from politics by adopting literacy and other complex “understanding” tests as prerequisites to voting. 7 other southern states follow suit." },
    { code:"R",
      date:"1890",
    ...
    { code:"A",
      date:"1892",
      text:"Geary Act extends the 1882 Chinese Exclusion Act, denies bail and writ of habeas corpus, and requires Chinese living in the U.S. to carry certificates of residence." },
    { code:"N",
      date:"1892",
    ...
    { code:"N",
      date:"1893",
      text:"The 400th anniversary of Columbus’s landing: Columbus Day is proclaimed a national holiday, and in honor of the celebration, the Pledge of Allegiance is written." },
    { code:"A",
      date:"1894",
      text:"Saito, a Japanese man, applies for U.S. citizenship. Courts refuse because he is neither white nor black." },
    { code:"M",
      date:"1896",
      text:"Dr.Ibrahim Awad Qaloush Arbeely published the first Arabic-English grammar book to help Syrian immigrants learn English." },
    { code:"R",
      date:"1896",
      text:"Plessy v. Ferguson - the precedent-setting \"separate-but-equal\" case - the U.S. Supreme Court dispensed with Plessy's contention that because he was only one-eighth Negro and could pass as White, he was entitled to ride in the seats reserved for Whites. The Court states that a Negro or Black is any person with any Black ancestry. This formalized the “one-drop” rule or the rule of hypodescent." },
    { code:"B",
      date:"1896",
      text:"The United States Supreme Court upholds the doctrine of separate but equal, paving the way for segregation of Blacks in all arenas. The Roberts decision was used to establish the “separate but equal” standard that formally legalized segregation in the U.S. until 1960. The court ruled that as long as equivalent facilities were provided, classification by race was not an abridgment of a person’s rights." },
    { code:"R",
      date:"1897",
      text:"Oklahoma prohibits intermarriage between Whites and Negroes or mulattos." },
    { code:"L",
      date:"1897",
      text:"Spain grants Cuba and Puerto Rico autonomy and home rule" },
    { code:"A",
      date:"1898",
      text:"Hawaii is annexed by force to the U.S." },
    { code:"L",
      date:"1898",
      text:"Spain signs the Treaty of Paris, transferring Cuba, Puerto Rico, and the Philippines to the U.S." },
    { code:"R",
      date:"1898",
    ...
    { code:"L",
      date:"1898",
      text:"Spanish-American War. U.S. invades and occupies Cuba, the Philippines, Puerto Rico, and other Spanish colonies in the Pacific Islands. Hawaii is also annexed by force." },
    { code:"A",
      date:"1898",
      text:"The treaty of Paris, which negotiates the end of the Spanish American War, cedes the Philippines and Guam to the U.S.." },
    { code:"L",
      date:"1898",
      text:"The U.S.S. Maine mysteriously blows up and President McKinley declares war against Spain. The U.S. military invades San Juan in pursuit of Spaniards and is welcomed by the cheering crowds, longing for independence." },
    { code:"A",
      date:"1900",
    ...
    { code:"A",
      date:"1900",
      text:"HI is incorporated as a territory of the U.S. but Chinese living in Hawaii is forbidden to travel to the U.S. mainland." },
    { code:"L",
      date:"1900",
      text:"11.4% of all U.S. immigrants are from Northern American, including Mexico – 86% are from Europe" },
    { code:"A",
      date:"1900",
    ...
    { code:"A",
      date:"1903",
      text:"About 2,000 Japanese and Mexican sugar beet workers go on strike in CA and form the first successful farm workers union. The American Federation of Labor refuses to recognize a non-white union" },
    { code:"N",
      date:"1903",
      text:"The descendents and community of Wounded Knee victims erect a memorial at the grave site." },
    { code:"L",
      date:"1903",
      text:"In Oxnard, Calif., more than 1,200 Mexican and Japanese farm workers organize the first farm worker union, the Japanese-Mexican Labor Association (JMLA). Later, it will be the first union to win a strike against the California agricultural industry, which already has become a powerful force." },
    { code:"B",
      date:"1903",
    ...
    { code:"L",
      date:"1917",
      text:"President Woodrow Wilson imposes US citizenship on Puerto Ricans to increase the pool of inductees for World War I." },
    { code:"L",
      date:"1917",
      text:"The Jones Act is passed, extending U.S. citizenship to all Puerto Ricans and creating 2 Puerto Rican houses of legislature whose representatives are elected by the people. English is decreed the official language of Puerto Rico" },
    { code:"L",
      date:"1917",
    ...
    { code:"M",
      date:"1923",
      text:"Famous poet Kahlil Gibran, a Lebanese-American authored The Prophet which gained popularity in the 1930s and sold more than 9 million copies in the U.S. Gibran is the third best-selling poet of all time, behind Shakespeare and Laozi." },
    { code:"B",
      date:"1923",
    ...
    { code:"A",
      date:"1929",
      text:"Ruby Foo’s Den opened in Boston Chinatown. Foo was one of the earliest female Chinese restaurants owners in U.S." },
    { code:"L",
      date:"1929-1939",
    ...
    { code:"R",
      date:"1931",
      text:"The Cable Act is amended, allowing U.S. women to retain the citizenship after marriage to aliens ineligible for citizenship. The Act is finally repealed in 1936." },
    { code:"A",
      date:"1931",
    ...
    { code:"M",
      date:"1932",
      text:"Dr. Michael DeBakey, a Lebanese American, invented the heart pump which allowed for open heart surgeries. Dr.Debakey was also Chairman of the Department of Surgery at Baylor College of Medicine and served as Chancellor from 1979 to 1996." },
    { code:"A",
      date:"1932",
    ...
    { code:"L",
      date:"1933",
      text:"Latino unions in California lead The El Monte Strike is organized by Latino unions in the Cannery and Agricultural Workers’ International Union to protest low wages for strawberry workers. Growers agree later that year to increase wages from 9 cents to 20 cents an hour." },
    { code:"L",
      date:"1933",
    ...
    { code:"L",
      date:"1934",
      text:"The Platt Amendment is annulled" },
    { code:"B",
      date:"1934",
    ...
    { code:"A",
      date:"1945",
      text:"6,000 Chinese women to enter United States as brides of American soldiers." },
    { code:"A",
      date:"1945",
      text:"The War Brides Act allows foreign-born wives of U.S. citizens who had served in the U.S. armed forces to enter the U.S." },
    { code:"L",
      date:"1945",
      text:"The War Brides Act allows foreign-born wives of U.S. citizens who had served in the U.S. armed forces to enter the U.S. African American, Mexican, and Asian veterans of World War II return to face racism and segregation." },
    { code:"L",
      date:"1945",
    ...
    { code:"R",
      date:"1950s-1960s",
      text:"Civil Rights Movement causes Adoption Industry to open up to and agencies work with Black families for the first time. TRA begin to increase with its “colorblind” placement practices." },
    { code:"A",
      date:"1950",
    ...
    { code:"L",
      date:"1950s",
      text:"Segregation is abolished in TX, AZ and other regions, largely through the efforts of LULAC and the Alianza Hispano Americana" },
    { code:"R",
      date:"1950",
      text:"By this time, anti-miscegenation legislation had extended beyond unions between Blacks and Whites and included Mongolians, Malayans, Mulattos and Native Americans." },
    { code:"L",
      date:"1950s-1960s",
    ...
    { code:"L",
      date:"1952",
      text:"McCarren Walter Act eliminates racial barriers to citizenship, but also tightens quotas for immigrants and allows deportation of immigrant for “subversive activities.”" },
    { code:"A",
      date:"1952",
    ...
    { code:"B",
      date:"1954",
      text:"By a unanimous vote, the United States Supreme Court, in the case of Brown v. Board of Education of Topeka, Kansas, declares that “separate but equal” educational facilities are “inherently unequal” and that segregation is therefore unconstitutional. The decision paves the way for large scale desegregation. This is a victory for NAACP attorney Thurgood Marshall" },
    { code:"N",
      date:"1954",
    ...
    { code:"N",
      date:"1961",
      text:"Nearly 800 Native American people from 90 Nations/tribes gathered at the Native American Chicago Conference and prepared the Declaration of Native American Purpose which addressed the inherent right of all people to retain spiritual and cultural values, and called for action toward formulating and adopting policies and programs empowering Native American people." },
    { code:"N",
      date:"1961",
      text:"Basil Williams, President of the Allegany Seneca, appealed to President John F. Kennedy to stop the Kinzua Dam. His plea was ignored. The building of the dam floods ~10,000 acres of habitable Seneca lands along the Allegheny River in NY and forced 1/3 of the population to relocate, violating , the government’s oldest active treaty (1794) with the Six Nations." },
    { code:"L",
      date:"1961",
    ...
    { code:"M",
      date:"1962",
      text:"Danny Thomas, a Christian Lebanese born as Amos Kairouz, founded St. Jude Children’s Research Hospital in Memphis, Tennessee. Thomas was also a comedian, singer and television actor." },
    { code:"L",
      date:"1962",
    ...
    { code:"N",
      date:"1963",
      text:"President Johnson presents Annie Dodge Wauneka with the Medal of Freedom, the nation’s highest civilian award, for her accomplishments in eradicating tuberculosis among Native people. To date, she is the 1st and only Native American so honored." },
    { code:"R",
      date:"1963",
    ...
    { code:"B",
      date:"1963",
      text:"Mississippi's NAACP field secretary, 37-year-old Medgar Evers, is murdered outside his home in Jackson, Miss.. Byron De La Beckwith is tried twice in 1964, both trials resulting in hung juries. Thirty years later he is convicted for murdering Evers." },
    { code:"B",
      date:"1963",
    ...
    { code:"B",
      date:"1968",
      text:"James Earl Ray, alleged assassin of Dr. Martin Luther King, Jr. is arrested." },
    { code:"B",
      date:"1968",
      text:"The world is shocked by the assassination of Dr. Martin Luther King, Jr. The assassination moves the United States House of Representatives to submit to President Johnson a Senate-passed civil rights bill prohibiting racial discrimination in the sale or rental of 80 percent of the nation’s housing. Johnson signs the measure on April 11." },
    { code:"N",
      date:"1968",
    ...
    { code:"L",
      date:"1968",
      text:"In Los Angeles, Latino high school student organize city-wide walkouts. Previously, Latino students were not allowed to use the bathroom during lunch, discouraged from applying to college, and punished for speaking Spanish on school property. Police respond with brutality: 13 students are arrested. The walkouts impact school reform and increased college enrollment in Latinos." },
    { code:"L",
      date:"1968",
    ...
    { code:"N",
      date:"1970",
      text:"President Richard M. Nixon delivered a speech to Congress, which denounced past federal policies, pronounced the end of termination, and called for a new era of self-determination for Native American peoples.\nPresident Nixon signs the law restoring the sacred Blue Lake to the people to Taos Pueblo, 64 years after it was taken from them and made part of Carson National Forest." },
    { code:"R",
      date:"1970s",
    ...
    { code:"N",
      date:"1971",
      text:"President Nixon signed into law the Alaska Native Claims Settlement Act, granting Alaska's 60,000 Native Americans, Inuits, and Aleuts title to 44 million acres of their ancient homeland and $962.5 million in settlement of the century-old question of Native land rights" },
    { code:"A",
      date:"1971",
    ...
    { code:"A",
      date:"1984",
      text:"President Reagan endorses a plan for acceptance for admission of all Amerasians, qualifying mothers, and siblings over the next 3 years through the Orderly Departure Program (ODP). Between 1982 and 1988, 4,500 Amerasian children and 7,000 accompanying relatives are brought to the U.S." },
    { code:"A",
      date:"1985- 2002",
    ...
    { code:"M",
      date:"1987",
      text:"A report released by the American-Arab Anti-Discrimination Committee (ADC) places California second in the nation in the number of acts of ‘political hate andviolence’ against Arab Americans." },
    { code:"M",
      date:"1987",
    ...
    { code:"A",
      date:"1992",
      text:"Korean businesses are looted and burned in riots in Los Angeles stemming from outrage over the Rodney King verdict." },
    { code:"A",
      date:"1992",
      text:"U.S. Bureau of the Census states: There were 39% more Japanese/white births than monoracial Japanese American births" },
    { code:"B",
      date:"1992",
    ...
    { code:"B",
      date:"1992",
      text:"Riots erupt in Los Angeles following the acquittal of four White police officers in the beating of Black motorist Rodney King." },
    { code:"B",
      date:"1992",
    ...
    { code:"R",
      date:"2008",
      text:"Barack Obama is elected President of the United States of America. President Obama identifies as African American, but openly acknowledges and discusses his multiracial heritage" },
    { code:"R",
      date:"2008",
    ...
    { code:"B",
      date:"2008",
      text:"Barack Obama is elected the first African American President of the United States of America. Lieutenant Governor David Paterson becomes first African American governor of New York, and the first legally blind governor of any US state." },
    { code:"B",
      date:"2009",
    ...
    { code:"R",
      date:"2009",
      text:"Barack Obama is inaugurated the first African American President of the United States of America." },
    { code:"B",
      date:"2010",
    ...
    { code:"A",
      date:"2010",
      text:"President Obama appointed Peter M. Rouse as interim chief of staff, the first Asian American to hold this position." },
    { code:"B",
      date:"2010",
    ...
    { code:"A",
      date:"2011",
      text:"Alexandra Wallace, a White UCLA student posted a video to YouTube, ranting about Asian American students lack of “American manners”. The video went viral, and lead to other White students across the country to post other videos targeting the Asian American community." },
    { code:"B",
      date:"2011",
      text:"On September 21, Troy Davis was executed by lethal injection. The was despite compelling evidence, as well as support from former president Jimmy Carter, Pope Benedict XVI, NAACP, and 600,000 people worldwide pleading for his innocence. The act was thought of as a racial hate crime and caused public uproar." },
    { code:"M",
      date:"2011-08",
