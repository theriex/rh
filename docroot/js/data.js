app.data = { credit:"Compiled by: Karen L. Suyemoto, Ph.D. - UMass (Boston) Psychology and Asian American Studies. Updated 2005/2006 by Claudia Fox Tree and Elli Stern for EMI Empowering Multicultural Initiatives. Updated 2014 by Emily Davis, for K. Suyemoto.",
  ...
  pts:[ { code:"NL",
    ...
    { code:"R",
      date:"1492",
      text:"Columbus sails and “discovers” the Americas. Although in the U.S. this is commemorated as Columbus Day, in parts of Latin American, they celebrate El Día de la Raza (the Day of the [New Mixed] Race)." },
    { code:"B",
      date:"1492",
    ...
    { code:"LN",
      date:"1492",
      text:"Columbus lands on a Caribbean island which he names San Salvador. There Native American population is over 5 million." },
    { code:"N",
      date:"1494",
    ...
    { code:"B",
      date:"1793",
      text:"Eli Whitney patents the cotton gin, which strengthens slavery by increasing profits in growing cotton." },
    { code:"B",
      date:"1793",
    ...
    { code:"NL",
      date:"1803",
      text:"France acquires the Louisiana Territory from Spain, which was ceded during the Seven Years’ War. Napoleon sells the vast territory to the U.S. for $15 million, expanding the borders of the infant nation to connect directly with New Spain" },
    { code:"B",
      date:"1803",
